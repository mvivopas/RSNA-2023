...
def ResNet50(num_classes=4, channels=3):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, num_channels=channels)


def ResNet101(num_classes=4, channels=3):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, num_channels=channels)


def ResNet152(num_classes=4, channels=3):
    return ResNet(Bottleneck, [3, 8, 36, 3], num_classes=num_classes, num_channels=channels)
